...
<body>
    ...
    <div class="card">
        <center><h3 class="card-header badge bg-secondary text-wrap rounded-4 m-4" style=" font-size: 50px;">::::: STUDENT PERSONAL DETAILS :::::</h3></center>
        <div class="card-body">
            <h1 class="card-title badge bg-success text-wrap rounded-1 p-2 m-2" style=" font-size: 40px; ">Student Name :   <?php echo($student['name']) ?></h1>
            <p class="card-text">
            ...
            <a href="listStudent.php" class="btn btn-secondary">Back</a>
        </div>
    </div>
